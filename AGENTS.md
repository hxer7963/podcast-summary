...
This is NOT a traditional CLI tool. It is a collection of **9 skills** that an AI agent invokes. The agent decides which skill to call based on the URL and environment. Skills are auto-discovered from `.agents/skills/`.
